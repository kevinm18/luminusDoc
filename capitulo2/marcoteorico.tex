...
Es importante mencionar este algoritmo debido a que es el precursor de otro algoritmo conocido como \nameref{c4.5}. Que es un algoritmo que apoya a la toma de decisiones, más avanzado y completo.Por otro lado, en\emph{Luminus} se realizará la implementación de este algoritmo.\\
