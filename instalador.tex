...
A continuación se muestra una tabla, con el listado del número de pasos que implica hacer la instalación mediante el \emph{Manual de instalación de Luminus} de estas tecnologías, con respecto al número de pasos y el tiempo que implica hacerlo mediante el instalador. 
\\
\begin{table}[H]
\begin{tabular}{|l|l|l|l|l|}
\hline
\textbf{Tarea}                                                   & \begin{tabular}[c]{@{}l@{}}\textbf{Pasos en el manual} \\ \textbf{de instalación}\end{tabular} & \begin{tabular}[c]{@{}l@{}}\textbf{Pasos en el} \\ \textbf{instalador}\end{tabular} & \begin{tabular}[c]{@{}l@{}} \textbf{Tiempo estimado necesario} \\ \textbf{manual de instalación} \end{tabular} & \begin{tabular}[c]{@{}l@{}} \textbf{Tiempo  estimado} \\\textbf{necesario  instalador} \end{tabular} \\ \hline
\begin{tabular}[c]{@{}l@{}}Instalación de la paquetería  \\ SSH en el Nodo Maestro    \end{tabular} & 9 pasos                                                                                   & 9  pasos &10 minutos &10 minutos                                                                       \\ \hline
\begin{tabular}[c]{@{}l@{}} Instalación de la paquetería \\SSH en los nodos de datos \end{tabular} & 4 pasos por nodo                                                                                  & \begin{tabular}[c]{@{}l@{}}4 pasos \\por nodo  \end{tabular}& 4 minutos por nodo & 4 minutos por nodo                                                                        \\ \hline
\begin{tabular}[c]{@{}l@{}} Instalación de la paquetería \\java en el Nodo Maestro  \end{tabular}  & 2 pasos                                                                                & ---- & 4 minutos & 30 segundos                                                                        \\ \hline

\begin{tabular}[c]{@{}l@{}}Instalación de Spark en el \\Nodo Maestro               \end{tabular}  & 7 pasos                                                                                   & ----   & 12 minutos & 4 minutos                                                                        \\ \hline
\begin{tabular}[c]{@{}l@{}} Instalación de la paquetería \\java en los nodos de datos \end{tabular} & 2 pasos por nodo                                                                                   & ---- & 4 minutos por nodo & 20 segundos por nodo                                                                           \\ \hline

\begin{tabular}[c]{@{}l@{}} Instalación de Spark en los \\nodos de datos        \end{tabular}   & 7 pasos por nodo                                                                                 & ----   & 15 minutos por nodo & 5 minutos por nodo                                                                        \\ \hline
\begin{tabular}[c]{@{}l@{}} Instalación de Apache Hadoop \\en el nodo maestro    \end{tabular}     & 20 pasos                                                                                  & ----   & 45 minutos &  3 minutos                                                                      \\ \hline
\begin{tabular}[c]{@{}l@{}}Instalación de Apache Hadoop \\en los nodos de datos   \end{tabular}    & 5 pasos por nodo                                                                                   & ----   & 8 minutos por nodo &3 minutos por nodo                                                                       \\ \hline
\begin{tabular}[c]{@{}l@{}} Puesta en funcionamiento \\(Pasos necesarios)    \end{tabular}           & 2 pasos                                                                                   & 2 pasos   & 2 minutos & 2 minutos                                                                     \\ \hline
\begin{tabular}[c]{@{}l@{}}Pasos adicionales del instalador             \end{tabular}           & ----                                                                                      & 5 pasos & ----& 2 minutos                                                                      \\ \hline

\begin{tabular}[c]{@{}l@{}}TOTAL para un maestro y \\un nodo  \end{tabular}                                                  & 58 pasos                                                                        & 20 pasos  & 104 minutos  & \begin{tabular}[c]{@{}l@{}}33 minutos \\ y 50 segundos   \end{tabular}                                                                  \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
	...
	\begin{center}	
		\includegraphics[width=.3\textwidth]{capitulo5/images/hostno1.png}
		\caption{El usuario introdujo la IP de un host no encontrado.}
...
\begin{figure}[H]
	...
	\begin{center}	
		\includegraphics[width=.7\textwidth]{capitulo5/images/configuracionhadoopesclavo2.png}
...
\begin{figure}[H]
	...
	\begin{center}	
		\includegraphics[width=.6\textwidth]{capitulo5/images/im51.png}
...
\begin{figure}[H]
	...
	\begin{center}	
		\includegraphics[width=.6\textwidth]{capitulo5/images/im52.png}
		\caption{Limpieza del HDFS}
		\label{fig:limpieza1}
	\end{center}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{center}	
		\includegraphics[width=.7\textwidth]{capitulo5/images/indice.png}
